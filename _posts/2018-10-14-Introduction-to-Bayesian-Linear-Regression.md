...
where $\boldsymbol{\mathfrak{A}}\triangleq\left[(\mathbf{x}_i^{\text{T}})\right]$, i.e. $\boldsymbol{\mathfrak{A}}\in(\mathbb{R}^{n}\times\mathbb{R}^d)$, this matrix is known as the <i>design matrix</i>. Given that $\mathbf{w}$ has the following prior distribution
<div style="overflow-x: auto;">
...
<img src="https://drive.google.com/uc?export=view&id=1XhKHztWM4OpxL1t_KzPxeU1kd40czUvK">
